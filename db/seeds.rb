...
event_attributes = [
  ...
  },
  {
    ...
    location:      "10 Rue du Faubourg Saint-Honoré 75008 Paris",
    city:      "Paris",
    category:  "food",
    user: User.all.sample,
  },

  {
    ...
    location:      "160 Rue du Faubourg Saint-Honoré 75008 Paris",
    city:      "Paris",
    category:  "WTF",
    user: User.all.sample,
  },

 {
    ...
    location:      "70 Rue du Faubourg Saint-Honoré 75008 Paris",
    city:      "Paris",
    category:  "music",
    user: User.all.sample,
  },
...

 {
    ...
    location:      "20 Rue du Faubourg Saint-Honoré 75008 Paris",
    city:      "Paris",
    category:  "art",
    user: User.all.sample,
  },
